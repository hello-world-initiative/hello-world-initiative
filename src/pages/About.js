...
const About = () => {
  return (
    <>
      ...
      <main>
        <Section color="dark">
          <Heading postiion="left">Coding education should be free for everyone.</Heading>
          ...
          <Heading position="right">HWI is community based.</Heading>
          ...
          <Heading position="right">We use free and inexpensive online learning materials.</Heading>
